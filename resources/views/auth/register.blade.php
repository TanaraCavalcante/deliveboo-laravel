                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Cinese" id="cinese"
                                            name="tipo[]">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Messicano" id="messicano"
                                            name="tipo[]">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Indiano" id="indiano"
                                            name="tipo[]">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Giapponese"
                                            id="giapponese" name="tipo[]">
                                        <label class="form-check-label" for="giapponese">
                                            Giapponese
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Vegetariano"
                                            id="vegetariano" name="tipo[]">
                                        <label class="form-check-label" for="vegetariano">
                                            Vegetariano
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Vegano" id="vegano"
                                            name="tipo[]">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Fast Food" id="fast_food"
                                            name="tipo[]">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Mediterraneo"
                                            id="mediterraneo" name="tipo[]">
